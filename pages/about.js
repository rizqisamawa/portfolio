...
function About() {
  return (
    <>
      ...
      <div className="mx-24 items-center justify-center mt-20 text-center">
        <p className="text-6xl font-sans font-semibold">Hello Everyone</p>
        ...
        <div className="text-center mt-10">
          <button className="bg-gray-500 font-mono p-2 text-white rounded-lg hover:bg-gray-800">
            npx rizqisamawa
          </button>
        </div>
      </div>
